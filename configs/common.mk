...
LOCAL_PATH:= vendor/inception/prebuilts/common/system

# Generic product
PRODUCT_NAME := inception
PRODUCT_BRAND := inception
...
# Common overlays
PRODUCT_PACKAGE_OVERLAYS += vendor/inception/overlays/common
...
# Backuptool support
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/addon.d/50-inception.sh:system/addon.d/50-simepleaosp.sh \
...
-include vendor/inception/configs/stockaudio.mk
